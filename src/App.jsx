...
import { Environment, OrbitControls, Sky, Cloud, CameraShake, Plane, Box } from '@react-three/drei'
    ...
    <>
      ...
      >
        <Suspense fallback={null}>
          <Grass>
            <mesh>
              <planeBufferGeometry args={[3, 3, 16]} rotate={[Math.PI / 5, 0, 0]} />
              <meshBasicMaterial color="808000" />
            </mesh>
          </Grass>
          {rand.map((e, i) => (
            <Butterfly key={i} {...e} />
